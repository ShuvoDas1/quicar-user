...
// const apiKey = "AIzaSyCdR88ykSQC7cQ2hvFa-q1LoBF1kqOel2U";
const apiKey = google_api_key;
const mapApiJs = 'https://maps.googleapis.com/maps/api/js';
const geocodeJson = 'https://maps.googleapis.com/maps/api/geocode/json';

// GOOGLE_MAP_API_KEY=AIzaSyCee008sHUYjld8cXawSR92mWk-sOfkLVw
...
function App() {
  ...
  const onChangeAddress = (autocomplete) => {
    ...
    console.log("place select",place);
  ...
  const findMyLocation = () => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(position => {
        console.log("position current place ",position);
    ...
    <div className="App">
      <div>
        <div className="search">
          {/* <span>Search</span> */}
          <input style={{width:'100%'}} ref={searchInput} type="text" placeholder="Search location...."/>
